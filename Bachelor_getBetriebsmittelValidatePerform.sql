DROP FUNCTION topology.getBetriebsmittelValidatePerform(topology text,tablename text,elementid int,typeid int);
CREATE OR REPLACE FUNCTION topology.getBetriebsmittelValidatePerform(topology text,tablename text,elementid int,typeid int)
RETURNS TABLE (
id int,
...
SELECT topology.getBetriebsmittelValidatePerform('gas_test','absperrarmatur',437082429,1);
SELECT topology.getBetriebsmittelValidate('gas_test','absperrarmatur',437082429,1);
SELECT topology.getBetriebsmittel('gas_test',437082429,1);